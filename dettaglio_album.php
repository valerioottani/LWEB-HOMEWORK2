        ...
        <div style="display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 40px;">
            <?php if ($res_merch && $res_merch->num_rows > 0): ?>
                <?php while ($prod = $res_merch->fetch_assoc()): ?>
                    ...
                    ?>
                    <div class="spotify-card" style="width: 240px; padding: 20px; text-align: center; display: flex; flex-direction: column; justify-content: space-between; position: relative; <?php echo $opacity_style; ?>">
                        ...
                        <?php if (!$is_soldout): ?>
                            <?php if ($is_logged): ?>
                                <a href="checkout_merch.php?merch_id=<?php echo (int)$prod['id']; ?>" class="buy-btn">Acquista Ora</a>
                            <?php else: ?>
                                <a href="login.php" class="buy-btn">Accedi per comprare</a>
                            <?php endif; ?>
                        <?php else: ?>
