...
<head>
    ...
    <style type="text/css">
        /* Effetto rilievo sui brani con cursore standard (senza manina) */
        .spotify-row-item {
        ...
        /* Pulsanti stile Spotify con cursore standard (senza manina) */
        .spotify-play-btn {
...
<body style="background: linear-gradient(180deg, #1f1f1f 0%, #121212 40%, #0a0a0a 100%); background-attachment: fixed; color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; margin: 0; padding: 0; min-height: 100vh;">
    ...
    <div style="margin-left: 230px; padding: 32px; max-width: 1200px;">
        ...
        <div style="display: flex; align-items: center; gap: 24px; margin-bottom: 28px; background: <?php echo $playlist_corrente['sfondo']; ?>; padding: 32px; border-radius: 12px; box-shadow: 0 8px 24px rgba(0,0,0,0.5);">
        ...
        <!-- BARRA COMANDI (Riproduci, Shuffle, Preferiti) senza manina -->
        <div style="display: flex; align-items: center; gap: 24px; margin-bottom: 32px;">
            <button class="spotify-play-btn" title="Riproduci">
                ▶
            </button>
            <button class="spotify-action-icon" title="Attiva sequenza casuale">
                🔀
            </button>
            <button class="spotify-action-icon" title="Salva nella libreria">
                ♡
            </button>
        </div>
