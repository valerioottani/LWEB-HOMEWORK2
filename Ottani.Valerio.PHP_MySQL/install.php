...
// Tabella aggiuntiva per i posti interattivi degli eventi
...
$merch_iniziale = [
    ...
    [3, 'CD Audio', 17.00, 'cd_marra.png', 1],
...
// 8. Popolamento Posti a sedere per gli eventi live (Nuova aggiunta)
$settori_base = [
...
// 10. Popolamento Messaggi di Default per la Community (con messaggi casuali degli utenti)
$messaggi_default = [
    ['Luchè', 'admin', 'Benvenuti nello spazio ufficiale della community! Condividete qui le vostre impressioni sui dischi.'],
    ['Geolier', 'utente', 'Il nuovo album è semplicemente pazzesco, non smetto di ascoltarlo.'],
    ['Marracash', 'admin', 'Il King del Rap non delude mai. Qual è la vostra traccia preferita di Persona?'],
    ['Lazza', 'utente', 'Sirio è un capolavoro assoluto dall inizio alla fine!'],
    ['Guè', 'utente', 'Madreperla ha un flow e dei beat che spaccano troppo.'],
    ['Sfera Ebbasta', 'admin', 'Preparatevi perché quest anno ci saranno grandissime novità live!'],
    ['SixTeenReid', 'utente', 'Bella raga, chi viene al prossimo concerto in tour?'],
    ['Luca Romeo', 'utente', 'Sto provando a rifare gli accordi di chitarra, pezzi incredibili.']
];
...
// 11. Popolamento Utenti Originali
...
<body style="background-color: #121212; color: #ffffff; font-family: Arial, sans-serif; padding: 40px; text-align: center;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #181818; padding: 32px; border-radius: 8px;">
        ...
        <p style="color: #b3b3b3; font-size: 14px; line-height: 1.6;">Database ripristinato con tutte le tracce nelle playlist, i messaggi casuali della community e i posti degli eventi.</p>
