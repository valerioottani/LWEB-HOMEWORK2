        ...
        <div style="flex: 1; max-width: 820px;">
            ...
            <div style="display: flex; gap: 18px; flex-wrap: wrap; margin-bottom: 40px;">
                <?php while ($pl = $res_playlist->fetch_assoc()): ?>
                    <a href="playlist.php?id=<?php echo $pl['id']; ?>" style="text-decoration: none; color: inherit;">
                        <div class="spotify-radio-card" style="background: <?php echo $pl['sfondo']; ?>; padding: 16px; border-radius: 8px; width: 175px; box-sizing: border-box; border: 1px solid rgba(255,255,255,0.05);">
            ...
            <div style="display: flex; gap: 18px; flex-wrap: wrap; margin-bottom: 40px;">
                <?php while ($chart = $res_classifiche->fetch_assoc()): ?>
                    <a href="playlist.php?id=<?php echo $chart['id']; ?>" style="text-decoration: none; color: inherit;">
                        <div class="spotify-radio-card" style="background: <?php echo $chart['sfondo']; ?>; padding: 16px; border-radius: 8px; width: 175px; box-sizing: border-box; border: 1px solid rgba(255,255,255,0.05);">
                            <div style="display: flex; justify-content: center; margin-bottom: 12px;">
            ...
            <div style="display: flex; gap: 18px; flex-wrap: wrap; margin-bottom: 40px;">
                <?php while ($alb = $res_albums->fetch_assoc()): ?>
                    <div class="spotify-card" style="padding: 16px; border-radius: 8px; width: 175px; box-sizing: border-box;">
                        <div style="display: flex; justify-content: center; margin-bottom: 12px;">
            ...
            <!-- Artisti (Ora cliccabili verso la pagina di dettaglio dell'artista) -->
            ...
            <div style="display: flex; gap: 18px; flex-wrap: wrap;">
                <?php while ($art = $res_artists->fetch_assoc()): ?>
                    <a href="artista.php?id=<?php echo $art['id']; ?>" style="text-decoration: none; color: inherit;">
                        <div class="spotify-card" style="padding: 16px; border-radius: 8px; width: 155px; text-align: center; box-sizing: border-box;">
                            <div style="display: flex; justify-content: center; margin-bottom: 12px;">
